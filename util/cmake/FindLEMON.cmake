...
message(STATUS "MEON_INCLUDE_PATH=${LEMON_INCLUDE_PATH}")

FIND_PATH(LEMON_INCLUDE_DIR
  lemon/core.h
  HINTS ${LEMON_INCLUDE_PATH}
...
message (STATUS "LEMON_LIBRARY=${LEMON_LIBRARY}, LEMON_INCLUDE_DIR=${LEMON_INCLUDE_DIR}")
